    ...
    <aside className="w-64 bg-card border-r border-border fixed left-0 top-0 h-screen flex flex-col">
      ...
      <div className="p-4 border-b border-border">
        ...
        >
          ...
          <span className="text-xl font-bold">Masrafi Panel</span>
        </Link>
      </div>
          ...
          return (
            <Link key={item.href} href={item.href}>
              <Button
                ...
                className={cn(
                  "w-full justify-start gap-3 hover:bg-indigo-800 hover:cursor-pointer hover:scale-105 transition-transform transform ease-in-out duration-500",
                  isActive &&
